...
- Device discovery / pairing / reconnect entry: start at `src/App.tsx`, `src/app/components/SnapLinkStage.tsx`, and `src/lib/use-ddzhilian.ts`; legacy `/`, `/connect`, `/send`, `/receive`, and `/sessions` paths resolve to `/text`.
