...
function AdminNavIcon({ name }: { name: AdminNavIconName }) {
  const icons: Record<AdminNavIconName, ReactNode> = {
    ...
    theme: <path d="M12 4a8 8 0 0 0-8 8 7 7 0 0 0 7 7h1.5a1.5 1.5 0 0 0 0-3H12a1.8 1.8 0 0 1 0-3.6h1.8A2.2 2.2 0 0 0 16 10.2 6.2 6.2 0 0 0 12 4ZM7.5 11h.1M9 8h.1M12 7h.1M15 8.5h.1" />,
