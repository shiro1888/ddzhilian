...
TEST_FILE = Path(r'C:\Project\ddzhilian\tmp\receive-direct-confirm.txt')
TEST_FILE.write_text('direct confirm receive test', encoding='utf-8')
result={}
with sync_playwright() as p:
    ...
    a.screenshot(path=str(OUT / 'dd-receive-direct-confirm-a.png'), full_page=True)
    b.screenshot(path=str(OUT / 'dd-receive-direct-confirm-b.png'), full_page=True)
    browser.close()
    if not dialog_seen:
        raise SystemExit(1)
print(result)
